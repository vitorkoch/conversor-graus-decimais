...
function converter() {
    ...
    if (validar(fieldGrausX) &&
        ...
        res.innerHTML = `y: ${sinalY + (grausY + minutosY / 60 + segundosY / 3600).toPrecision(5)}<br>x: ${sinalX + (grausX + minutosX / 60 + segundosX / 3600).toPrecision(5)}`;
    }
    else {
