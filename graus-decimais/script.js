...
function converter() {
    ...
    if (validate(fielddegreesX) &&
        ...
        res.innerHTML = `y: ${sinalY + (degreesY + minutesY / 60 + secondsY / 3600).toPrecision(5)}<br>x: ${sinalX + (degreesX + minutesX / 60 + secondsX / 3600).toPrecision(5)}`;
    }
    else {
